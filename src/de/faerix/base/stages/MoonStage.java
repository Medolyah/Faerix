...
public class MoonStage extends BasicGameState implements GameStage{
	...
	public void init(GameContainer gc, StateBasedGame sbg) throws SlickException {
		...
		startBild = new Image("assets/moonstage.png").getScaledCopy(gc.getWidth(), gc.getHeight());
		this.gamehub = new GameHub(); 
		this.handler = StagesHandler.getInstance();
		this.level = this.handler.getLevel(StageEnum.MoonStage);
	...
	public void goToNextLevel(StateBasedGame game) {
		...
		System.out.println("MOONSTAGE NEXT LEVEL ID:" + nextLevel);
